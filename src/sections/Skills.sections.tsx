      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex-1 flex flex-col justify-between  bg-[#000000] bg-opacity-40 p-6 rounded-lg shadow-xl border border-[#0c1426] border-opacity-50">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                // 🎨 UI Layer (CAP full-stack)
                "SAP Fiori",
                "SAP UI5",

                // ⚙️ Backend (supporting CAP)
                "Python",
                "Node.js",
                "TypeScript",
                "REST APIs",
        ...
        <div className="mt-12 bg-[#000000] bg-opacity-40 p-6 rounded-lg shadow-xl border border-[#0c1426] border-opacity-50">
          ...
          <div className="space-y-6">
            {[
              { name: "SAP CAP Full-Stack Development", percentage: 90 },
              { name: "SAP Fiori / UI5 Development", percentage: 85 },
              { name: "SAP BTP & Cloud Services", percentage: 85 },
              {
                name: "Generative AI Integration (Joule / AI Core)",
                percentage: 75,
              },
              { name: "API & OData Service Development", percentage: 80 },
            ].map((skill) => (
